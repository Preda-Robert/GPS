...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	if (!InitializeShader(device, hwnd, L"shaders/vs/Color.vs", L"shaders/ps/Color.ps")) {
		return false;
	}
...
bool ColorShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatirx)
{
